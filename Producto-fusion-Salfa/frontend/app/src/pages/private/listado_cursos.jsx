  ...
  const filteredCursos = useMemo(() => {
    return cursos
      ...
      .filter((curso) => {
        ...
        if (statusFilter === "activos") return curso.estado_curso === true;
        if (statusFilter === "inactivos") return curso.estado_curso === false;
        return true;
      });
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-6">
          ...
          >
            ...
            <SelectContent>
              ...
              <SelectItem value="inactivos">Deshabilitados</SelectItem>
            </SelectContent>
          </Select>
