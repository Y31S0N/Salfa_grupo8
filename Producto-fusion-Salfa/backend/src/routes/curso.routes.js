...
import {
  ...
  habilitarCurso,
  obtenerUsuariosCurso,
  obtenerUsuariosCursoPorArea,
...
router.get("/api/curso/:id/usuarios", obtenerUsuariosCurso);
router.get("/api/curso/:id/usuarios/area/:areaId", obtenerUsuariosCursoPorArea);
